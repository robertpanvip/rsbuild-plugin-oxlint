...
<p>
  ...
  <a href="https://npmcharts.com/compare/rsbuild-plugin-rslint?minimal=true"><img src="https://img.shields.io/npm/dm/rsbuild-plugin-example.svg?style=flat-square&colorA=564341&colorB=EDED91" alt="downloads" /></a>
</p>
...
```ts
// rsbuild.config.ts
import { rslintPlugin } from 'rsbuild-plugin-rslint';
